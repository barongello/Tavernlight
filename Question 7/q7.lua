...
function startWindow()
    ...
    autoMoveEvent = periodicalEvent(jumpButtonAutoMove, nil, JUMP_BUTTON_AUTO_MOVE_TIMEOUT)
end

-- Reset window and trigger button states
function resetWindow()
    -- If there is a periodical event, remove it
...
function jumpButtonAutoMove()
    ...
    -- If hit the left side, send it back to right side
