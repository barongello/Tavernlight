...
MAP_SHADERS = { {
    ...
    name = 'Map - Question 5',
    frag = 'shaders/fragment/q5.frag',
    tex1 = 'images/q5'
}, {
    name = 'Map - Question 6',
    frag = 'shaders/fragment/q6_map.frag',
    tex1 = 'images/q6'
}, {
    name = 'Map - Fog',
...
OUTFIT_SHADERS = { {
    ...
    name = 'Outfit - Black',
    frag = 'shaders/fragment/outfitblack.frag'
}, {
    name = 'Outfit - Question 6',
    frag = 'shaders/fragment/q6_outfit.frag',
    useFramebuffer = true
}, {
    name = 'Outfit - Rainbow',
    frag = 'shaders/fragment/party.frag'
